    ...
    def _guide_ui(self):
        ...
        sections = [
            ("\U0001f3e0  Sidebar", "#4F46E5", [
                ("Navigation", "Left sidebar, collapsed to icons by default. Click the header to expand to full labels. Groups: Home, then DAILY (Transactions, Database, Balances, Split), CARDS (Credit Cards, Debit Cards), REVIEW & PLANNING (Audit, Wealth), TOOLS (Notes, Settings, Gmail)."),
